...
export function Terminal({ onClose }: TerminalProps) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-hidden rounded-lg border border-cyber-border-subtle bg-[#0d1117]">
...
{`  ╔══════════════════════════════════════════════════════╗
  ...
  ╚══════════════════════════════════════════════════════╝`}
            ...
            <div className="text-[#c9d1d9] text-xs space-y-1">
              ...
              <p className="text-[#8b949e]">{t('banner.scanningHint')}</p>
            </div>
          </div>
        ) : (
